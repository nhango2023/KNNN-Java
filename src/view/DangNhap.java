			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					if (rs != null && rs.next()) {
						...
						String maNguoiDung = "";
						String tenNguoiDung = "";
//						app.mnAdmin.setVisible(true);
						app.mnQuanLy.setVisible(true);
						if (rs != null && rs.next()) {
							if (maLoaiTaiKhoan.equals("LTK001")) {
								maNguoiDung = rs.getString("MAADMIN");
								tenNguoiDung = rs.getString("TEN");
								app.mntmHoatDong.setVisible(true);
								app.mntmGiangVien.setVisible(true);
								app.mntmSinhVien.setVisible(true);
								app.mntmTaiKhoan.setVisible(true);
								app.mntmKhoa.setVisible(true);
								app.mntmLop.setVisible(true);
							} else {
								if (maLoaiTaiKhoan.equals("LTK002")) {
								...
								app.mntmHoatDong.setVisible(true);
								app.mntmGiangVien.setVisible(false);
								app.mntmSinhVien.setVisible(false);
								app.mntmTaiKhoan.setVisible(false);
							}
						...
						app.NguoiDung.setLoaiUser(maLoaiTaiKhoan);
